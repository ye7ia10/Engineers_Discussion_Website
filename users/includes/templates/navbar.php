...
<nav class="navbar navbar-inverse" style="flood-color: red;">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li ><a href="../users/ask.php">Ask question <span class="sr-only">(current)</span></a></li>
        <?php
        if($_SESSION['ID1'] == 1){?>
        <li ><a href="../admin/members.php">Members <span class="sr-only">(current)</span></a></li>
      <?php } ?>
      <li ><a href="../users/user.php">Posts <span class="sr-only">(current)</span></a></li>
      
      <li ><a href="../users/departs.php">departs <span class="sr-only">(current)</span></a></li>
